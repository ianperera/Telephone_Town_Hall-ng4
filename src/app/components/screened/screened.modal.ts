...
@Component({
    selector: 'screened-modal-content',
    template: `
...
export class ScreenedModalContent {
    @Input() name;
...
@Component({
    selector: 'screened-modal-component',
    templateUrl: './screened-modal-component.html'
})

export class ScreenedModalComponent {
    constructor(private modalService: NgbModal) {}

    open() {
        const modalRef = this.modalService.open(ScreenedModalContent);
