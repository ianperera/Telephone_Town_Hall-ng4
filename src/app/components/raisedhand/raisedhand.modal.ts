...
@Component({
    selector: 'raisedhand-modal-content',
    template: `
...
export class RaisedHandModalContent {
    @Input() name;
...
@Component({
    selector: 'raisedhand-modal-component',
    templateUrl: './raisedhand-modal-component.html'
})

export class RaisedHandModalComponent {
    constructor(private modalService: NgbModal) {}

    open() {
        const modalRef = this.modalService.open(RaisedHandModalContent);
