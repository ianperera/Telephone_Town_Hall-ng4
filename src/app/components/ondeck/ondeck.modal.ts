...
export class OnDeckModalContent {
    @Input() name;
...
@Component({
    selector: 'ondeck-modal-component',
    templateUrl: './ondeck-modal-component.html'
})

export class OnDeckModalComponent {
    constructor(private modalService: NgbModal) {}

    open() {
        const modalRef = this.modalService.open(OnDeckModalContent);
